...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = r"C:\\Users\\admin\\Desktop\\stt\\project2\\text-to-speech-455413-09c4f83b2fbd.json"
...
while True:
    ...
    if alerts:
        ...
        tamil_voice_message = "கவனி! உங்கள் உடல்நிலை சரியாக இல்லை " + " ".join(alerts)
